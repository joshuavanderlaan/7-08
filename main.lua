...
local character = display.newImageRect( "./assets/character.png", 175, 175 )
...
local luigi = display.newImageRect( "./assets/character.png", 100, 155 )
...
function jumpButton:touch( event )
    ...
    if ( event.phase == "ended" ) then
        ...
        character:setLinearVelocity( 0, -750 )
...
function shootButton:touch( event )
    ...
    if ( event.phase == "began" ) then
        ...
        local aSingleBullet = display.newImageRect( "./assets/bullet.jpg", 80, 30)

        aSingleBullet.x = character.x + 30

        aSingleBullet.y = character.y
...
function leftshootButton:touch( event )
    ...
    if ( event.phase == "began" ) then
        ...
        local aSingleBullet2 = display.newImageRect( "./assets/bullet.jpg", 80, 30)

        aSingleBullet2.x = character.x- 30

        aSingleBullet2.y = character.y
...
function checkCharacterPosition( event )
    ...
    if character.y > display.contentHeight + 500 then
